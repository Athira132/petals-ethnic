-- =====================================================================
-- PETALS ETHNIC - COMPLETE SUPABASE DATABASE SCHEMA & SEED MIGRATION
-- Copy and run this entire file in your Supabase SQL Editor:
-- https://supabase.com/dashboard/project/giqngsukscyghqkjtijc/sql/new
-- =====================================================================
...
-- Insert Initial 7 Categories with exact direct ImgBB links
